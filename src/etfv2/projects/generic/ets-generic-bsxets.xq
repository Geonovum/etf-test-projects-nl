...
declare variable $projDir external :="/home/thijs/code/Geonovum/ETF/github/etf-test-projects-nl/src/etfv2/projects/GML32";
...
declare variable $etsFile external := $projDir || file:dir-separator() || "1_geometry" || file:dir-separator() || "geometrytest-bsxets.xml";
