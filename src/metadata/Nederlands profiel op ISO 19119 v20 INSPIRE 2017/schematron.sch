...
-->
		...
		<!-- Metadata verantwoordelijke organisatie (name) https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata -->
			<sch:let name="mdResponsibleParty_OrganisationString" value="normalize-space(gmd:contact[1]/gmd:CI_ResponsibleParty/gmd:organisationName[gco:CharacterString or gmx:Anchor]/*)"/>
	...
	https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting -->
		...
		<!-- Trefwoorden NL profie -->
			...
			<sch:let name="keyword" value="normalize-space(gmd:identificationInfo[1]/*/gmd:descriptiveKeywords[1]/*/gmd:keyword[1][gco:CharacterString or gmx:Anchor]/*)"/>
	...
	<!-- eind  INSPIRE	SDS-->
		...
		<!-- Specificatie date https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum	-->
			...
			<sch:let name="conformity_Spec_Title_SDS_Invoc" value="normalize-space(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-invocable'])='invocable'"/>
			<sch:let name="conformity_Spec_Title_SDS_Interop" value="normalize-space(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-interoperable'])='interoperable'"/>
			<sch:let name="conformity_Spec_Title_SDS_Harmo" value="normalize-space(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-harmonised'])='harmonised'"/>
