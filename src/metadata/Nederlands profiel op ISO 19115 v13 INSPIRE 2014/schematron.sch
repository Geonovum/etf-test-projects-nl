...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	<!-- INSPIRE Thesaurus en Conformiteit-->
		...
		<!-- alle regels over elementen binnen gmd:dataQualityInfo[1] -->
		...
		<!-- INSPIRE specification titel -->
			...
			<sch:rule id="INSPIRE specificaties" context="//gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation">
