...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	<sch:pattern id="Validatie tegen het Nederlands metadata profiel op ISO 19119">
		...
		<!-- schemalocatie controleren, overeenkomstig inspire en nl profiel -->
			...
			<sch:assert id="Schema locatie service metadata" test="contains(normalize-space(@xsi:schemaLocation), 'http://schemas.opengis.net/csw/2.0.2/profiles/apiso/1.0.0/apiso.xsd')">Het ISO 19139 XML document mist een verplichte schema locatie. De schema locatie http://schemas.opengis.net/csw/2.0.2/profiles/apiso/1.0.0/apiso.xsd moet aanwezig zijn.
		    	</sch:assert>
			<sch:report id="Schema locatie service metadata info " test="contains(normalize-space(@xsi:schemaLocation), 'http://schemas.opengis.net/csw/2.0.2/profiles/apiso/1.0.0/apiso.xsd')">Het ISO 19139 XML document bevat de schema locatie http://schemas.opengis.net/csw/2.0.2/profiles/apiso/1.0.0/apiso.xsd
			</sch:report>
		<!--  fileIdentifier -->
		...
		<!-- Samenvatting -->
		 ...
		 <!-- Trefwoorden  voor INSPIRE -->
			...
			or text() = 'infoCoverageAccessService'])[1])"/>
		...
		<!-- Als  de GEMET INSPIRE themes thesaurus voorkomt, is verwijzing naar inspire specificatie verplicht -->
			...
			<sch:assert id="INSPIRE Specificaties (ISO nr. 360) " test="not($thesaurus_INSPIRE_Exsists) or ($thesaurus_INSPIRE_Exsists and $conformity_Spec_Title_Exsists)">Specificatie (ISO nr. 360) mist de verplichte waarden voor INSPIRE services, Als dit geen INSPIRE service is verwijder dan de thesaurus GEMET -INSPIRE themes, voor INSPIRE service in specificatie opnemen; VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens</sch:assert>
		...
		<!-- service type -->
			<sch:assert id="Service type " test="$serviceType">Service type ontbreekt of heeft de verkeerde waarde</sch:assert>
